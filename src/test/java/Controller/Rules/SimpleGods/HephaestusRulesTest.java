...
public class HephaestusRulesTest {
    static Rules rules;
    static Game game;
    static Board board;
    ...
    @Test
    public void nextPossibleActions_multipleFloorsAroundAfterFirstBuild_endRoundOrHephaestusPower() {
        player1.getWorker(Genre.MALE).setPosition(board.getCell(1, 2));
        player1.getWorker(Genre.FEMALE).setPosition(board.getCell(3, 4));
        ...
        roundActionWithMoveAndBuild.add(new Action(ActionType.BUILD_FLOOR, Genre.FEMALE, Direction.S, 1));
    ...
    @Test
    public void nextPossibleActions_AfterFirstDome_endRound() {
        player1.getWorker(Genre.MALE).setPosition(board.getCell(1, 2));
        player1.getWorker(Genre.FEMALE).setPosition(board.getCell(3, 4));
        ...
        RoundActions roundActionWithMoveAndDome = new RoundActions();
        roundActionWithMoveAndDome.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        roundActionWithMoveAndDome.add(new Action(ActionType.BUILD_DOME, Genre.FEMALE, Direction.SE, 3));
        player2.setRoundActions(roundActionWithMoveAndDome);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
    ...
    @Test
    public void nextPossibleActions_noHephaestusConditionAfterFirstBuild_endRound() {
        player1.getWorker(Genre.MALE).setPosition(board.getCell(1, 2));
        player1.getWorker(Genre.FEMALE).setPosition(board.getCell(3, 4));
        ...
        RoundActions roundActionWithMoveAndBuild = new RoundActions();
        roundActionWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        roundActionWithMoveAndBuild.add(new Action(ActionType.BUILD_FLOOR, Genre.FEMALE, Direction.SE, 2));
        player2.setRoundActions(roundActionWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
    ...
    @Test
    public void nextPossibleActions_afterSecondBuild_endRound() {
        player1.getWorker(Genre.MALE).setPosition(board.getCell(1, 2));
        player1.getWorker(Genre.FEMALE).setPosition(board.getCell(3, 4));
        ...
        RoundActions roundActionWithMoveAndBuild = new RoundActions();
        roundActionWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -1));
        roundActionWithMoveAndBuild.add(new Action(ActionType.BUILD_FLOOR, Genre.FEMALE, Direction.SE, 1));
        roundActionWithMoveAndBuild.add(new Action(ActionType.BUILD_FLOOR, Genre.FEMALE, Direction.SE, 2));
        player2.setRoundActions(roundActionWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
