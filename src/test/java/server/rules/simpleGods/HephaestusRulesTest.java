...
public class HephaestusRulesTest {
    ...
    public void nextPossibleActions_multipleFloorsAroundAfterFirstBuild_endRoundOrHephaestusPower() {
        ...
        raWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.S, 1));
    ...
    public void nextPossibleActions_AfterFirstDome_endRound() {
        ...
        RoundActions raWithMoveAndDome = new RoundActions();
        raWithMoveAndDome.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        raWithMoveAndDome.add(new Action(ActionType.DOME, Genre.FEMALE, Direction.SE, 3));
        player2.setRoundActions(raWithMoveAndDome);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
    ...
    public void nextPossibleActions_noHephaestusConditionAfterFirstBuild_endRound() {
        ...
        RoundActions raWithMoveAndBuild = new RoundActions();
        raWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        raWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.SE, 2));
        player2.setRoundActions(raWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
    ...
    public void nextPossibleActions_afterSecondBuild_endRound() {
        ...
        RoundActions raWithMoveAndBuild = new RoundActions();
        raWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -1));
        raWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.SE, 1));
        raWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.SE, 2));
        player2.setRoundActions(raWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
