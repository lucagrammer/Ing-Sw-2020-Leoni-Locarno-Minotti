...
public class DemeterRulesTest {
    ...
    public void nextPossibleActions_multipleFloorsAroundAfterFirstDome_endRoundOrDemetraPower() {
        ...
        raWithMoveAndDome.add(new Action(ActionType.DOME, Genre.FEMALE, Direction.SE, 0));
    ...
    public void nextPossibleActions_allOccupiedAfterFirstBuild_endRound() {
        ...
        RoundActions raWithMoveAndBuild = new RoundActions();
        raWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        raWithMoveAndBuild.add(new Action(ActionType.DOME, Genre.FEMALE, Direction.SE, 3));
        player2.setRoundActions(raWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
    ...
    public void nextPossibleActions_afterSecondBuild_endRound() {
        ...
        RoundActions raWithMoveAndBuild = new RoundActions();
        raWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        raWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.S, 2));
        raWithMoveAndBuild.add(new Action(ActionType.DOME, Genre.FEMALE, Direction.SE, 3));
        player2.setRoundActions(raWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
