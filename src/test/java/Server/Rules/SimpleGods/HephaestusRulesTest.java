...
public class HephaestusRulesTest {
    ...
    public void nextPossibleActions_multipleFloorsAroundAfterFirstBuild_endRoundOrHephaestusPower() {
        ...
        roundActionWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.S, 1));
    ...
    public void nextPossibleActions_AfterFirstDome_endRound() {
        ...
        roundActionWithMoveAndDome.add(new Action(ActionType.DOME, Genre.FEMALE, Direction.SE, 3));
    ...
    public void nextPossibleActions_noHephaestusConditionAfterFirstBuild_endRound() {
        ...
        RoundActions roundActionWithMoveAndBuild = new RoundActions();
        roundActionWithMoveAndBuild.add(new Action(ActionType.MOVE, Genre.FEMALE, Direction.NW, -3));
        roundActionWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.SE, 2));
        player2.setRoundActions(roundActionWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
    ...
    public void nextPossibleActions_afterSecondBuild_endRound() {
        ...
        roundActionWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.SE, 1));
        roundActionWithMoveAndBuild.add(new Action(ActionType.FLOOR, Genre.FEMALE, Direction.SE, 2));
        player2.setRoundActions(roundActionWithMoveAndBuild);
        RoundActions nextPossibleActions = rules.nextPossibleActions(player2, game);
