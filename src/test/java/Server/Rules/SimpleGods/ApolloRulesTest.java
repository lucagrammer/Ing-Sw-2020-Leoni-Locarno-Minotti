...
public class ApolloRulesTest {
    ...
    @Test
    public void nextPossibleActions_noDomesNoFloorAroundFirstMove_moveToAllCorrectCells() {
        ...
        expectedActions.add(new Action(ActionType.MOVE, Genre.MALE, Direction.NE, 0));
    ...
    @Test
    public void doAction_doApolloMove_notWinningMove() {
    ...
    @Test
    public void doAction_doApolloMove_winningMove() {
        player1.getWorker(Genre.MALE).setPosition(board.getCell(1, 3));
        player1.getWorker(Genre.FEMALE).setPosition(board.getCell(3, 4));
